-- Comprehensive fix for town achievement claim button
-- Addresses all issues with the claim system

-- First, let's ensure all required database structures exist
...
-- Drop and recreate the claim function with better error handling
