-- Auto Wiki Pages Migration
-- This migration creates triggers and functions to automatically generate wiki pages
-- when new towns or nations are added to the database
...
BEGIN
  ...
  -- This will be handled by the edge function which has access to the wiki bucket
  PERFORM
    net.http_post(
